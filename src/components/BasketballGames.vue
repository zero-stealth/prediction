    ...
    <form @submit.prevent="handleSubmit" enctype="multipart/form-data" class="form-container">
      <div class="form-wrapper">
        ...
        <div class="form-group">
          ...
          <input v-model="teamA" type="text" class="form-g-input" placeholder="lebron" id="teamA" />
        </div>
        <div class="form-group">
          <label for="teamAIcon">Player image:</label>
          <input @change="handleTeamALogo" type="file" class="form-g-input" id="Image" accept="image/*" />
        </div>
        <div class="form-group">
      ...
      <div class="form-wrapper">
        ...
        <div class="form-group">
          ...
          <input v-model="teamB" type="text" class="form-g-input" placeholder="Curry" id="teamB" />
        </div>
        <div class="form-group">
  ...
  if (
    ...
    try {
      ...
      const response = await axios.post(
        'https://predictions-reg9.onrender.com/sports/create/Basketball',
        formData,
        {
          headers: {
