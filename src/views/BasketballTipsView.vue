...
import standingsSection from '../components/basketball/standingsSection.vue'
import tipsSection from '../components/basketball/tipsSection.vue'
...
const showAds = () => {
  cardAdsImg.value = filteredAds.value[0]?.image || null
